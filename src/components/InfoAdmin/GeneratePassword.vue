...
/* .card {
  ...
  background-image: linear-gradient(
    ...
    url('https://d33wubrfki0l68.cloudfront.net/55a0fb34834126eb34bc98f3318d18c50d79c4a0/14764/en/blog/what-does-a-ux-designer-do-header-image-d3615a6f363cd9332837a4b8621aeb9ac1bcff522da3bc90332e1b3e46259cfe.jpg');
  padding: 60px 30px;
  border-radius: 20px;
  display: grid;
  grid-template-areas: 'generator options';
  grid-gap: 10px;
